...
<head>
    ...
    * {
    ...
    .weather-mini .weather-icon { font-size: 17px; }
    .weather-mini .weather-temp { font-weight: 700; color: var(--brand); }
    .weather-mini .weather-city { color: var(--text-2); font-size: 13px; }
    .weather-mini .weather-loading { color: var(--text-3); font-size: 13px; }
    ...
    .login-modal-full {
        ...
        justify-content: center;
        background:
            radial-gradient(800px 500px at 18% 12%, var(--bg-glow-1), transparent 60%),
            radial-gradient(700px 500px at 85% 82%, var(--bg-glow-2), transparent 60%),
            rgba(8, 12, 18, 0.55);
        backdrop-filter: blur(14px);
        -webkit-backdrop-filter: blur(14px);
    ...
    .weather-modal-content {
        ...
        padding: 24px;
        box-shadow: var(--shadow-lg);
        animation: weatherModalIn 0.3s ease;
    }
    ...
    .weather-search-item:last-child {
        border-bottom: none;
    }
    ...
    .weather-search-item-name {
        font-weight: 600;
        font-size: 15px;
        color: var(--text);
    }

    .weather-search-item-path {
        font-size: 13px;
        color: var(--text-3);
        margin-top: 2px;
    }
...
<body>
    ...
    <div class="fixed-elements">
        ...
        <h3 class="site-title">
            ...
            <span class="weather-mini" id="weather-mini" onclick="openWeatherModal()"><span class="weather-loading">加载中...</span></span>
        </h3>
